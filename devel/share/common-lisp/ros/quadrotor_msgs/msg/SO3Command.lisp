...
(cl:defmethod omega_d-val ((m <SO3Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:omega_d-val is deprecated.  Use quadrotor_msgs-msg:omega_d instead.")
  (omega_d m))

(cl:ensure-generic-function 'omega_d_dot-val :lambda-list '(m))
(cl:defmethod omega_d_dot-val ((m <SO3Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:omega_d_dot-val is deprecated.  Use quadrotor_msgs-msg:omega_d_dot instead.")
  (omega_d_dot m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SO3Command>) istream)
  ...
  (cl:setf (cl:slot-value msg 'omega_d) (cl:make-array 3))
  (cl:let ((vals (cl:slot-value msg 'omega_d)))
    (cl:dotimes (i 3)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:aref vals i) (roslisp-utils:decode-double-float-bits bits)))))
  (cl:setf (cl:slot-value msg 'omega_d_dot) (cl:make-array 3))
  (cl:let ((vals (cl:slot-value msg 'omega_d_dot)))
    (cl:dotimes (i 3)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SO3Command>)))
  ...
  "c82859493dd48c4c93d5b2ac92d97819")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SO3Command)))
  "Returns md5sum for a message object of type 'SO3Command"
  "c82859493dd48c4c93d5b2ac92d97819")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SO3Command>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'omega_d) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'omega_d_dot) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SO3Command>))
  ...
  (cl:list 'SO3Command
    ...
    (cl:cons ':omega_d_dot (omega_d_dot msg))
))

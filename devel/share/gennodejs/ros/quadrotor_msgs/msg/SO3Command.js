...
class SO3Command {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('omega_d')) {
        ...
        this.omega_d = new Array(3).fill(0);
      }
      if (initObj.hasOwnProperty('omega_d_dot')) {
        this.omega_d_dot = initObj.omega_d_dot
      }
      else {
        this.omega_d_dot = new Array(3).fill(0);
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [omega_d] has the right length
    if (obj.omega_d.length !== 3) {
      throw new Error('Unable to serialize array field omega_d - length must be 3')
    }
    // Serialize message field [omega_d]
    bufferOffset = _arraySerializer.float64(obj.omega_d, buffer, bufferOffset, 3);
    // Check that the constant length array field [omega_d_dot] has the right length
    if (obj.omega_d_dot.length !== 3) {
      throw new Error('Unable to serialize array field omega_d_dot - length must be 3')
    }
    // Serialize message field [omega_d_dot]
    bufferOffset = _arraySerializer.float64(obj.omega_d_dot, buffer, bufferOffset, 3);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.omega_d = _arrayDeserializer.float64(buffer, bufferOffset, 3)
    // Deserialize message field [omega_d_dot]
    data.omega_d_dot = _arrayDeserializer.float64(buffer, bufferOffset, 3)
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'c82859493dd48c4c93d5b2ac92d97819';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.omega_d !== undefined) {
      ...
      resolved.omega_d = new Array(3).fill(0)
    }

    if (msg.omega_d_dot !== undefined) {
      resolved.omega_d_dot = msg.omega_d_dot;
    }
    else {
      resolved.omega_d_dot = new Array(3).fill(0)
    }

...
class PositionCommand {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('predicted_trajectory')) {
        ...
        this.predicted_trajectory = new trajectory_msgs.msg.MultiDOFJointTrajectory();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = trajectory_msgs.msg.MultiDOFJointTrajectory.serialize(obj.predicted_trajectory, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.predicted_trajectory = trajectory_msgs.msg.MultiDOFJointTrajectory.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += trajectory_msgs.msg.MultiDOFJointTrajectory.getMessageSize(object.predicted_trajectory);
    return length + 145;
  }
  ...
  static md5sum() {
    ...
    return 'fbda8c6b4995c875d350eee881ddf0ed';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.predicted_trajectory !== undefined) {
      resolved.predicted_trajectory = trajectory_msgs.msg.MultiDOFJointTrajectory.Resolve(msg.predicted_trajectory)
    }
    else {
      resolved.predicted_trajectory = new trajectory_msgs.msg.MultiDOFJointTrajectory()
    }

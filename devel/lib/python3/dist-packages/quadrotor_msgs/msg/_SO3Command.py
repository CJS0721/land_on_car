...
class SO3Command(genpy.Message):
  _md5sum = "c82859493dd48c4c93d5b2ac92d97819"
...
"""
  __slots__ = ['header','force','orientation','kR','kOm','aux','omega_d','omega_d_dot']
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','float64[3]','float64[3]','quadrotor_msgs/AuxCommand','float64[3]','float64[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,force,orientation,kR,kOm,aux,omega_d,omega_d_dot
    ...
    if args or kwds:
      ...
      if self.omega_d is None:
        self.omega_d = [0.] * 3
      if self.omega_d_dot is None:
        self.omega_d_dot = [0.] * 3
    else:
      self.header = std_msgs.msg.Header()
      self.force = geometry_msgs.msg.Vector3()
      self.orientation = geometry_msgs.msg.Quaternion()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_3d().pack(*self.omega_d))
      buff.write(_get_struct_3d().pack(*self.omega_d_dot))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.omega_d = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 24
      self.omega_d_dot = _get_struct_3d().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.aux.enable_motors, _x.aux.use_external_yaw))
      buff.write(self.omega_d.tostring())
      buff.write(self.omega_d_dot.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.omega_d = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=3)
      start = end
      end += 24
      self.omega_d_dot = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=3)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill

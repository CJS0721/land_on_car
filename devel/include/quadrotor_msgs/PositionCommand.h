...
struct PositionCommand_
{
  ...
  _kv_type kv;
   ...
   typedef  ::trajectory_msgs::MultiDOFJointTrajectory_<ContainerAllocator>  _predicted_trajectory_type;
...
struct MD5Sum< ::quadrotor_msgs::PositionCommand_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xfbda8c6b4995c875ULL;
  static const uint64_t static_value2 = 0xd350eee881ddf0edULL;
};
...
struct Printer< ::quadrotor_msgs::PositionCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::quadrotor_msgs::PositionCommand_<ContainerAllocator>& v)
  {
    ...
    s << std::endl;
    Printer< ::trajectory_msgs::MultiDOFJointTrajectory_<ContainerAllocator> >::stream(s, indent + "  ", v.predicted_trajectory);
    s << indent << "N: ";

...
struct SO3Command_
{
  ...
  _aux_type aux;
   ...
   typedef boost::array<double, 3>  _omega_d_type;
  _omega_d_type omega_d;

   typedef boost::array<double, 3>  _omega_d_dot_type;
  _omega_d_dot_type omega_d_dot;
...
bool operator==(const ::quadrotor_msgs::SO3Command_<ContainerAllocator1> & lhs, const ::quadrotor_msgs::SO3Command_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.omega_d_dot == rhs.omega_d_dot;
}
...
struct MD5Sum< ::quadrotor_msgs::SO3Command_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc82859493dd48c4cULL;
  static const uint64_t static_value2 = 0x93d5b2ac92d97819ULL;
};
...
struct Printer< ::quadrotor_msgs::SO3Command_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::quadrotor_msgs::SO3Command_<ContainerAllocator>& v)
  {
    ...
    s << indent << "omega_d[]" << std::endl;
    for (size_t i = 0; i < v.omega_d.size(); ++i)
    {
      s << indent << "  omega_d[" << i << "]: ";
      Printer<double>::stream(s, indent + "  ", v.omega_d[i]);
    }
    s << indent << "omega_d_dot[]" << std::endl;
    for (size_t i = 0; i < v.omega_d_dot.size(); ++i)
    {
      s << indent << "  omega_d_dot[" << i << "]: ";
      Printer<double>::stream(s, indent + "  ", v.omega_d_dot[i]);
    }
  }
};
